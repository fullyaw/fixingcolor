...
aurel_slider_object.setup = function(action) {
    ...
    if (!this.interval) {
	  this.interval = setInterval("aurel_slider_object.move.call(aurel_slider_object,1)", aurel_slider_object.options.speed);
    }
}
...
aurel_slider_object.move = function(dir) {
    ...
    var slideNo = this.active_slide;

	this.update.call(this,slideNo);
}
